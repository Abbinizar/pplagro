    ...
    <div class="w3-row-padding">
      <div class="w3-col m12">
        <div class="w3-card w3-round w3-white">
          ...
          @foreach($data as $row)
            <form action="{{url('admin/ubahrekening')}}/{{$row->id_rekening}}" method="post"  enctype="multipart/form-data">
              {{csrf_field()}}
              <h6 class="w3-opacity">Ubah Rekening</h6>
              <hr class="w3-clear">
            
              <label for="atasnama"  style="width: 100px;">Atas nama : </label>
              <input type="text" name="atasnama" value="{{$row->atasnama}}" id="atasnama" class="w3-rest w3-border">
              <br>
              ...
              <input type="text" name="norekening" value="{{$row->norekening}}" id="norekening" class="w3-rest w3-border">
              <br>
